export function createAdminTemplate (body:any){
...
<head>
    ...
    <title>Contact-Form</title><!--[if (mso 16)]>
<style type="text/css">
...
<![endif]-->
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#000000">
                        ...
                        <tr>
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://srmkcb.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important;background-color:#EC6D64;background-repeat:repeat;background-position:center top">
                        <tr>
                            <td align="center" bgcolor="#171616" style="padding:0;Margin:0;background-color:#171616">
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="Margin:0;padding-right:10px;padding-left:10px;padding-top:25px;padding-bottom:25px;font-size:0">
                                                                    <a href="${process.env.NEXT_PUBLIC_DOMAIN}" target="_blank"
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px"><img
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr>
                            <td style="padding:0;Margin:0;background-color:#333333" bgcolor="#333333" align="center">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <h2
                                                                        style="Margin:0;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:29px;color:#111111">
                                                                    ${body.name} filled the form</h2>
                                                                </td>
                                                            </tr>
                                                            <tr>
                        ...
                        <tr>
                            <td align="center" bgcolor="#333333" style="padding:0;Margin:0;background-color:#333333">
                                <table class="es-content-body"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="padding:0;Margin:0;padding-right:30px;padding-left:30px;padding-bottom:20px">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                    <td valign="top" align="center"
                                                ...
                                                <tr>
                                                    <td valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="Margin:0;padding-top:20px;padding-right:30px;padding-left:30px;padding-bottom:40px">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;letter-spacing:0;color:#666666;font-size:18px">
                                                                        This is a computer generated mail</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
